...
class ApplicationConfig:
    ...
    def __init__(self, asset_file_path: Optional[str] = None, 
        ...
        Args:
            ...
            exchange_rate_provider: 汇率提供商，目前支持 "boc_hk"
        """
    ...
    def get_exchange_service(self) -> ExchangeRateService:
        ...
        if self._exchange_service is None:
            if self._exchange_rate_provider == "boc_hk":
                ...
                raise ValueError(f"Unsupported exchange rate provider: {self._exchange_rate_provider}")
    ...
    def validate_configuration(self) -> bool:
        ...
        try:
            ...
            # 检查汇率提供商是否支持
            supported_providers = ["boc_hk"]
            if self._exchange_rate_provider not in supported_providers:
